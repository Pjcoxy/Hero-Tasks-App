...
| **Static Web App** | `modules/staticwebapp.bicep` | Free tier frontend. It calls the Function App directly by the Function App's own hostname; Function App CORS is scoped to the deployed Static Web App origin |
